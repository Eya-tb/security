    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/recovery/initiate").permitAll()
                        .requestMatchers("/api/recovery/validate-code").permitAll()
                        .requestMatchers("/api/recovery/complete").permitAll()
                        .requestMatchers("/api/auth/password/check-key-recovery/**").permitAll()
                        .requestMatchers("/api/auth/password/reset-with-key-recovery").permitAll()
                        .requestMatchers("/api/keys/recovery/status/**").authenticated()
